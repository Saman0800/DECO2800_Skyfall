...
public class TextureManager extends AbstractManager {
    ...
    public TextureManager() {
        try {
            ...
            textureMap.put("sand_car_SOUTH", new Texture("resources/new_sand_car/sand_car_front_with_player.png"));
            textureMap.put("sand_car_NORTH", new Texture("resources/new_sand_car/sand_car_back.png"));
            textureMap.put("sand_car_WEST", new Texture("resources/new_sand_car/new_sand_car_left_with_player.png"));
            textureMap.put("sand_car_EAST", new Texture("resources/new_sand_car/new_sand_car_right_with_player.png"));
            textureMap.put("sand_car_SOUTHWEST", new Texture("resources/new_sand_car/sand_car_front_left_with_player.png"));
            textureMap.put("sand_car_SOUTHEAST", new Texture("resources/new_sand_car/sand_car_front_right_with_player.png"));
            textureMap.put("sand_car_NORTHEAST", new Texture("resources/new_sand_car/sand_car_back_right_with_player.png"));
            textureMap.put("sand_car_NORTHWEST", new Texture("resources/new_sand_car/sand_car_back_left_with_player.png"));
