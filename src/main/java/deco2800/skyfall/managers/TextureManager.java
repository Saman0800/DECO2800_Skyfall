...
public class TextureManager extends AbstractManager {
    ...
    public TextureManager() {
        try {
            ...
            textureMap.put("your_mission", new Texture("resources/new_ui/tutorial/your_mission.png"));
            textureMap.put("tutorial_1", new Texture("resources/new_ui/tutorial/tutorial_1.png"));
            textureMap.put("tutorial_2", new Texture("resources/new_ui/tutorial/tutorial_2.png"));
            textureMap.put("tutorial_3", new Texture("resources/new_ui/tutorial/tutorial_3.png"));
            textureMap.put("tutorial_4", new Texture("resources/new_ui/tutorial/tutorial_4.png"));
            textureMap.put("tutorial_5", new Texture("resources/new_ui/tutorial/tutorial_5.png"));
//            textureMap.put("next_back_button", new Texture("resources/new_ui/tutorial/next_back_button.png"));
//            textureMap.put("home_button", new Texture("resources/new_ui/tutorial/home_button.png"));
