...
public class TextureManager extends AbstractManager {
    ...
    public TextureManager() {
        try {
            ...
            textureMap.put("sand_car_WEST", new Texture("resources/new_sand_car/sand_car_left_with_player.png"));
            textureMap.put("sand_car_EAST", new Texture("resources/new_sand_car/sand_car_right_with_player.png"));
