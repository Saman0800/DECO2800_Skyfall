...
public class Renderer3D implements Renderer {
     ...
     */
    private ScreenManager.MainCharacter findPlayerPeon(List<AbstractEntity> entities) {
        // find playerPeon in the entities list
        ScreenManager.MainCharacter mainCharacter = null;
        // iterate abstract entity to find Player peon
        for (AbstractEntity e : entities) {
            if (e instanceof ScreenManager.MainCharacter) {
                mainCharacter = (ScreenManager.MainCharacter) e;
            }
        }
    ...
    private void renderAbstractEntities(SpriteBatch batch, OrthographicCamera camera) {
        ...
        ScreenManager.MainCharacter playerPeon = findPlayerPeon(entities);
